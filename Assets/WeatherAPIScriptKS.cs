...
public class WeatherAPIScriptKS : MonoBehaviour
{
    public GameObject weatherTextObject;
        // add your personal API key after APPID= and before &units=
       string url = "http://api.openweathermap.org/data/2.5/weather?lat=38.9717&lon=-95.2353&APPID=3a428b266346933443d13456a7182e67&units=imperial";
